...
let pfCells: Array<IPFCell> = [];	//array tempat menyimpan semua cell yang dibuat
 ...
 */
function pfTelusurBalik(cell: IPFCell, res: Array<IPFCell>): void {
	let i: number = 0;
	let cellTemp: IPFCell = null;
	let cellParent: IPFCell = null;
	let len: number;
 ...
 */
function pfBuatCell(parent: IPFCell, x: number, y: number, tx: number, ty: number): IPFCell {
	let cell: IPFCell = {
		x: x,
		y: y,
		buka: 1,
 ...
 */
function pfRes2Array(res: Array<IPFCell>): Array<any> {
	let ar: Array<any> = [];
 ...
 * @param ty posisi target y
 */
function pfCariJalan3(sx: number, sy: number, tx: number, ty: number): Array<any> {
 ...
 */
function pfCariCellTerbuka(): IPFCell {
	let i: number = 0;
	let cell: IPFCell = null;
	let maxLen: number;
	let cellTemp: IPFCell;
	let len: number = 0;
 ...
 * @param ty posisi target y
 */
function pfBukaCell(cellCr: IPFCell, tx: number, ty: number): void {
	//up
 ...
 * @param ty posisi target y
 */
function pfCariJalan(sx: number, sy: number, tx: number, ty: number): any[] {
	let cellCr: IPFCell;
	let res: Array<IPFCell> = [];
