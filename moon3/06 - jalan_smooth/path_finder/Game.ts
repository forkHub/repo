...
namespace fg {
    export class Game {
        ...
        private langkahIdx: number = 0;
        private langkahTotal: number = 10;
        ...
        drawChar(): void {
            let bmp: createjs.Bitmap;
            let pos: createjs.Point = new createjs.Point();
            let pos2: createjs.Point = new createjs.Point();
            let langkah: createjs.Point = new createjs.Point();
