class Clip {
    ...
    get getBtnLeft() {
        return document.body.querySelector('nav-btn button.prev');
    }
    get getBtnRight() {
        return document.body.querySelector('nav-btn button.next');
    }
    get getBtnGoto() {
    ...
    get getMaxOffsetX() {
        ...
        let lastPos;
        let width;
        lastTab = this.getTabsTop().children.item(this.getTabsTop().children.length - 1);
    ...
    getTabPosAtIdx(i) {
        let el = this.getTabsTop().children.item(i);
