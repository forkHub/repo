...
/** BLITZ-SPRITE.TS */
declare const CreateSprite: (image: IBuffer, dragable?: boolean) => ha_blitz.ISprite;
declare const PositionSprite: (sprite: ha_blitz.ISprite, x?: number, y?: number) => void;
declare const DrawSprite: (sprite: ha_blitz.ISprite, frame?: number) => void;
