class BinopEditor {
    ...
    private static exp1: HTMLElement;
    private static exp2: HTMLElement;
    private static op: HTMLElement;
    // private static binop: IBinop;
    ...
    private static init(): void {
        if (!this.exp1) {
            this.exp1 = ha.comp.Util.getEl('div.exp1', this.view);
            this.exp1.onclick = (e: MouseEvent) => {
                e.stopPropagation();

                if (expForm.tipeArg == ARG_VALUE) {
                    this.exp2.innerText = expForm.value;
                    ...
                    this.exp2.innerText = Variable.getVar(parseInt(expForm.ref)).nama;
        ...
        if (!this.exp2) {
            this.exp2 = ha.comp.Util.getEl('div.exp2', this.view);
            this.exp2.onclick = (e: MouseEvent) => {
                e.stopPropagation();
