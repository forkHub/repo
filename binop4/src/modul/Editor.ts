namespace modul.editor {
    ...
    export async function exec() {
        ...
        //buat modul
        let modulObj: IModul;
        modulObj = window.modul.buat('mulai', 0);
        ...
        modulObj = window.modul.buat('loop', 0);
        modulObj.view.attach(view.halaman);
...
async function init(): Promise<void> {
    await modul.editor.exec();
    modul.editor.menu.tambah.exec();
    modul.editor.menu.utama.view.attach(modul.editor.view.menu);
    system.menu.exec();
}
